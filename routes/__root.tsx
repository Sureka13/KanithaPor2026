...
import { Outlet, createRootRouteWithContext, useRouter, HeadContent } from "@tanstack/react-router";
  ...
  head: () => ({
    meta: [
      ...
      { title: "KanithaPor 2026 — Math Quiz Competition" },
      {
        name: "description",
        content:
          "KanithaPor 2026 (கணிதப் போர்) — interactive math quiz competition for Indian students in Standards 1–6.",
      },
